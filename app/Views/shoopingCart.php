    ...
    <main class="max-w-4xl w-full mx-auto bg-white min-h-screen">
        ...
        <div class="w-full overflow-x-auto p-3">
            ...
            <div class="flex items-center justify-end mt-3">
                <button id="bayar" class="uppercase px-5 py-2 rounded bg-sky-700 hover:bg-sky-500 text-white">Bayar</button>
            </div>
        </div>
    </main>
    <!-- transaksi dialog -->
    <div class="absolute top-0 left-0 w-full h-screen bg-zinc-900 bg-opacity-50 flex items-center justify-center invisible" id="dialog">
        ...
        <div class="w-full max-w-lg h-96 bg-white rounded p-5 relative">
            ...
            <div class="px-3 py-2">
                ...
                <input type="text" name="nama" id="nama" class="flex-1 w-full px-3 py-2 mb-3 focus:outline-transparent border-b-2 transition-colors border-zinc-300 focus:border-emerald-500 outline-transparent" placeholder="Nama" required>
                <input type="text" name="alamat" id="alamat" class="flex-1 w-full px-3 py-2 mb-3 focus:outline-transparent border-b-2 transition-colors border-zinc-300 focus:border-emerald-500 outline-transparent" placeholder="Alamat" required>
                <input type="number" inputmode="numeric" name="telp" id="telp" class="flex-1 w-full px-3 py-2 mb-3 focus:outline-transparent border-b-2 transition-colors border-zinc-300 focus:border-emerald-500 outline-transparent" placeholder="No Telp" required>
                <button type="submit" class="uppercase text-white bg-sky-700 flex-1 w-full px-3 py-2 font-semibold rounded mt-3 bg-sky-700 hover:bg-sky-500 cursor-pointer">
                    bayar
                </button>
            </div>
        </div>
